%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%This code creates Figure 7d and Table VIId
...
set(h_cel_d2d_RIS_median,'LineWidth',2.9,'Color',[0.52, 0.18, 0.11])
set(h_cel_d2d_RIS_HD_median,'LineWidth',1.5, 'Color',[255/255 1/255 255/255])
grid on
hold off
xlim([0,300])
