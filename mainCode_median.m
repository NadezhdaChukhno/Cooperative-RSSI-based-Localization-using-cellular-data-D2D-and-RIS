...
%3 - 4 points on the corners on fixed distance [not used in paper]
%4 - 4 points on the corners on variable (5,20) distance
%% Cellular settings
...
%% add the cycle
    for index_user=1:number_of_evaluation_points
        ...
        % %               plot(X_B,Y_B,'o');
                ...
                elseif mode_d2d==3
                  %% corner fixed
                    fixed_dist=randi([5 20]);
                    X_a1=realX-fixed_dist;
                    Y_a1=realY-fixed_dist;
                    X_a2=realX+fixed_dist;
                    Y_a2=realY-fixed_dist;
                    X_a3=realX-fixed_dist;
                    Y_a3=realY+fixed_dist;
                    X_a4=realX+fixed_dist;
                    Y_a4=realY+fixed_dist;
        ...
        estimanted_pos_cel_D2D_RIS_median(index_user,:)= [ median([estimanted_pos_cel(index_user,1) estimanted_pos_D2D(index_user,1) estimanted_pos_RIS(index_user,1)]), median([estimanted_pos_cel(index_user,2) estimanted_pos_D2D(index_user,2) estimanted_pos_RIS(index_user,2)])];
        error_cel_D2D_RIS_median(index_counter,:)=real(sqrt( (estimanted_pos_cel_D2D_RIS_median(index_user,1)- realX).^2 + ( estimanted_pos_cel_D2D_RIS_median(index_user,2)- realY).^2 )); %% 

        estimanted_pos_cel_D2D_RIS_HD_median(index_user,:)= [ median([estimanted_pos_cel(index_user,1) estimanted_pos_D2D_HD(index_user,1) estimanted_pos_RIS(index_user,1)]), median([estimanted_pos_cel(index_user,2) estimanted_pos_D2D_HD(index_user,2) estimanted_pos_RIS(index_user,2)])];
        error_cel_D2D_RIS_HD_median(index_counter,:)=real(sqrt( (estimanted_pos_cel_D2D_RIS_HD_median(index_user,1)- realX).^2 + ( estimanted_pos_cel_D2D_RIS_HD_median(index_user,2)- realY).^2 )); %% 
...
%% CDF of INDIVIDUAL ERROR
 ...
 hold on
 [h_cel_d2d_RIS_median,stats_cel_d2d_RIS_median] = cdfplot(error_cel_D2D_RIS_median);
  hold on
 [h_cel_d2d_RIS_HD_median,stats_cel_d2d_RIS_HD_median] = cdfplot(error_cel_D2D_RIS_HD_median);
 ...
 srt_cel_d2d_RIS_median={strcat('Cellular+D2D FD+RIS median, \mu=',num2str(stats_cel_d2d_RIS_median.mean,'%.2f'),', \sigma=',num2str(stats_cel_d2d_RIS_median.std,'%.2f'))};
 srt_cel_d2d_RIS_HD_median={strcat('Cellular+D2D HD+RIS median, \mu=',num2str(stats_cel_d2d_RIS_HD_median.mean,'%.2f'),', \sigma=',num2str(stats_cel_d2d_RIS_HD_median.std,'%.2f'))};
 legend(srt_cel{1,1},srt_d2d{1,1},srt_d2d_HD{1,1},srt_RIS{1,1},srt_cel_d2d{1,1},srt_cel_d2d_HD{1,1},srt_cel_RIS{1,1},srt_cel_d2d_RIS{1,1},srt_cel_d2d_RIS_HD{1,1},srt_cel_d2d_RIS_median{1,1},srt_cel_d2d_RIS_HD_median{1,1},'Location','best')
...
error_cel_D2D_RIS_prc_median=prctile(error_cel_D2D_RIS_median,[50 75 95]);
error_cel_D2D_RIS_prc_HD_median=prctile(error_cel_D2D_RIS_HD_median,[50 75 95]);
%MSE RMSE
...
error_cel_D2D_RIS_MSE_median=mean(error_cel_D2D_RIS_median.^2);
error_cel_D2D_RIS_MSE_HD_median=mean(error_cel_D2D_RIS_HD_median.^2);
...
error_cel_D2D_RIS_RMSE_median=sqrt(error_cel_D2D_RIS_MSE_median);
error_cel_D2D_RIS_RMSE_HD_median=sqrt(error_cel_D2D_RIS_MSE_HD_median);

%save('EXP4_Pt05_LOS_simple_30UE_1000runs_D2D_mode1_RIS1024_rand_dist_FD_HD_NLOS.mat'); 